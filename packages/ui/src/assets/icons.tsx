...
export const IconVendors = (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => {
  return (
    <svg {...props} fill="none" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M13 6C13 8.76142 10.7614 11 8 11C5.23858 11 3 8.76142 3 6C3 3.23858 5.23858 1 8 1C10.7614 1 13 3.23858 13 6Z"
        fill="currentColor"
        fillOpacity="0.4"
      />
      <path d="M13 16H22V22H13V16Z" fill="currentColor" fillOpacity="0.4" />
      <path
        d="M23.978 16.306C23.841 17.265 23.072 18 22.142 18H21.523C20.497 18 19.666 17.105 19.666 16C19.666 17.105 18.835 18 17.809 18H17.19C16.164 18 15.333 17.105 15.333 16C15.333 17.105 14.502 18 13.476 18H12.857C11.928 18 11.158 17.265 11.021 16.306C10.993 16.107 11.039 15.903 11.116 15.717L11.471 14.856C11.934 13.733 13.029 13 14.244 13H20.753C21.968 13 23.063 13.733 23.526 14.856L23.881 15.717C23.958 15.903 24.005 16.107 23.976 16.306H23.978ZM22 19C21.447 19 21 19.448 21 20V21C21 21.551 20.552 22 20 22H15C14.448 22 14 21.551 14 21V20C14 19.448 13.553 19 13 19C12.447 19 12 19.448 12 20V21C12 22.654 13.346 24 15 24H20C21.654 24 23 22.654 23 21V20C23 19.448 22.553 19 22 19ZM2 6C2 2.691 4.691 0 8 0C11.309 0 14 2.691 14 6C14 9.309 11.309 12 8 12C4.691 12 2 9.309 2 6ZM4 6C4 8.206 5.794 10 8 10C10.206 10 12 8.206 12 6C12 3.794 10.206 2 8 2C5.794 2 4 3.794 4 6ZM8 14C3.589 14 0 17.589 0 22V23C0 23.552 0.447 24 1 24C1.553 24 2 23.552 2 23V22C2 18.691 4.691 16 8 16C8.553 16 9 15.552 9 15C9 14.448 8.553 14 8 14Z"
        fill="currentColor"
      />
    </svg>
  );
